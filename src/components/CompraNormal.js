...
function CompraNormal() {
    ...
    return (
        <section className='compraContainer'>
                ...
                {mensajeError?<section className='errorStock'><h2>Hay un error en la compra, intente otra vez</h2>
                    <h3>Alguno de los elementos que está intentando comprar no tenemos en Stock</h3></section>:
